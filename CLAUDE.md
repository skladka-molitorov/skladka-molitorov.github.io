...
**Neopravené vady časové osy (stav 22. 8. 2026):** budoucí termíny jsou v nesprávném pořadí, 25. 8. stojí před 20. 8., a blok 20. 8. je stále veden jako budoucí (`tl-budouci`), přestože datum minulo. Stránky `docs/souhrn.md` a články z 27. a 29. 7. navíc pořád vyzývají k podpisu petice „do 20. srpna". Vypořádá to petiční článek po sečtení podpisů, plánovaný po 24. 8. Drafty čekající na vydání jsou v repu spolek ve `verejnost/web_k_publikaci/`, vydané v jeho podsložce `_vydane/` - **do `docs/` se kopírují teprve v den publikace** (MkDocs kopíruje celé `docs/assets/` do `site/`, takže příloha nevydaného článku by byla živá na doméně).
